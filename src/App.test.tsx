...
describe('App', () => {
  ...
  it('shows onboarding directly without a consent dialog when no active vault is configured', async () => {
    ...
    expect(screen.queryByText('Help improve Tolaria')).not.toBeInTheDocument()
